...
public sealed class AuditRestoreServiceTests
{
    ...
    public async Task Preview_DeleteWithSnapshot_IsRestorable()
    {
        ...
        context.AuditOperations.Add(new AuditOperation
        {
            ...
            ActionType = "DELETE",
            EntityCode = "dominio",
            PhysicalTableName = "TMDominio",
            CorrelationId = "delete-1",
            Status = "SUCCESS",
            OccurredAtUtc = DateTime.UtcNow,
            Snapshots = [new AuditDeletedRecordSnapshot
            {
    ...
    public async Task Preview_ExpiredOrIncompatibleSnapshot_IsBlockedWithoutMutation()
    {
        ...
        context.AuditOperations.AddRange(
            new AuditOperation
            {
                ...
                Status = "SUCCESS",
                OccurredAtUtc = DateTime.UtcNow.AddDays(-31),
            ...
            new AuditOperation
            {
                OperationId = incompatibleId,
                ActionType = "DELETE",
                EntityCode = "x",
                PhysicalTableName = "Unknown",
