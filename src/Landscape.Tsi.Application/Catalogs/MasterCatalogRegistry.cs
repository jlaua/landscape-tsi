...
public static class MasterCatalogRegistry
{
    ...
    [
        ...
        Define("proceso-adopcion-empresa", "Empresa en Proceso de Adopción", "TProcesoAdopcionEmpresa", "idProcesoAdopcionEmpresa", "proceso-adopcion-empresa", "Organización", "justificacionNoAplica", CatalogEditorMode.Modal,
            [ForeignKey("proceso", "idProcesoAdopcionTSI", "Proceso de adopción", "proceso-adopcion-tsi"), ForeignKey("empresa", "idEmpresaSubsidiaria", "Empresa subsidiaria", "empresa-subsidiaria"), Text("aplica", "aplica", "Aplica"), Text("justificacionNoAplica", "justificacionNoAplica", "Justificación si no aplica", true), Date("fechaIncorporacion", "fechaIncorporacion", "Fecha de incorporación")], ["proceso", "empresa", "aplica", "fechaIncorporacion"], CatalogEntityType.Transactional, "Participación y estado de aplicación de subsidiarias en procesos de adopción."),
        ...
        Define("vendor", "Vendor", "TVendor", "idVendor", "vendor", "Organización", "nombreVendor", CatalogEditorMode.Modal,
            [ForeignKey("tecnologia", "idTecnologiaTSI", "Tecnología TSI", "tecnologia-tsi"), Text("nombreVendor", "nombreVendor", "Nombre del vendor")], ["nombreVendor", "tecnologia"], CatalogEntityType.Transactional, "Proveedores o fabricantes relacionados con tecnología TSI."),
        Define("contacto-vendor", "Contacto de Vendor", "TContactoVendor", "idContactoVendor", "contacto-vendor", "Organización", "nombreContactoVendor", CatalogEditorMode.Modal,
            [ForeignKey("vendor", "idVendor", "Vendor", "vendor"), Text("nombreContactoVendor", "nombreContactoVendor", "Nombre del contacto"), Text("email", "email", "Correo electrónico"), Text("telefono", "telefono", "Teléfono")], ["nombreContactoVendor", "vendor"], CatalogEntityType.Transactional, "Contactos comerciales o técnicos asociados a un vendor."),
        Define("contacto-partner", "Contacto de Partner", "TContactoPartner", "idContactoPartner", "contacto-partner", "Organización", "nombreContactoPartner", CatalogEditorMode.Modal,
            [ForeignKey("vendor", "idVendor", "Vendor", "vendor"), Text("nombreContactoPartner", "nombreContactoPartner", "Nombre del partner"), Text("email", "email", "Correo electrónico"), Text("telefono", "telefono", "Teléfono")], ["nombreContactoPartner", "vendor"], CatalogEntityType.Transactional, "Contactos comerciales o técnicos asociados a un partner de tecnología.")
    ];
